<template>
  <section>
    <section class="header-web">
      <a class="logo-box"><img src="../../assets/images/logo.png"></a>
      ...
      <div class="nav-box">
        ...
        <router-link :to="{ name: 'product-center'}">
          产品中心
        </router-link>
        ...
        <router-link :to="{ name: 'enterprise'}"
            v-if="!userInfo.isPlatform && userInfo.isEnterpriseRoot">
          企业信息
        </router-link>
